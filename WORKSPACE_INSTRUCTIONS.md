# WORKSPACE_INSTRUCTIONS.md — LogoVisualizer Backend
...
| `LogoVisualizer.Data/Repositories/` | `IProductRepository` (`GetAllAsync`, `GetByIdWithZonesAsync`, `CreateAsync`, `DeleteAsync`, `ExistsAsync`) + `IPrintZoneRepository` + implementations |
